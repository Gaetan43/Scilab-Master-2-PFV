...
getd("C:\Users\gaetan\Desktop\TP scilab Master 2\Contrôle Continue");
...
Files = findfiles('C:\Users\gaetan\Desktop\TP scilab Master 2\Contrôle Continue\données CC\SPRINT_RADAR', "*.txt")
B = size(Files)
...
sheets= readxls("C:\Users\gaetan\Desktop\TP scilab Master 2\Contrôle Continue\données CC\masse_taille.xls");
